                ...
                <hr class="featurette-divider" />
                    ...
                    <div class="row featurette">
                        <div class="col-md-7 order-md-2">
                            ...
                            <p class="lead">Another featurette? Of course. More img content here to give you an idea of how this layout would work with some actual real-world content in place.</p>
                        </div>
                        <div class="col-md-5 order-md-1">
                           < img alt=''  width="250" height="250" background="#eee" color="#aaa" class="bd-img alt=''-img alt=''-lg featurette-image img-fluid mx-auto" />
                        </div>
                    </div>
                    ...
                    <hr class="featurette-divider" />
                        ...
                        <div class="row featurette">
                            ...
                            <div class="col-md-5">
                               < img alt='' width="250" height="250" background="#eee" color="#aaa" class="bd-placeholder-img-lg featurette-image img-fluid mx-auto" />
                            </div>
                        </div>
